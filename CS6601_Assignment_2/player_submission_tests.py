...
from section1c.submission import OpenMoveEvalFn, CustomPlayer, minimax, alphabeta
...
def alpha_pruning_test_eq_to_minimax(yourAgent, minimax_fn=alphabeta):
    """Example test to make sure
    your minimax works, using the
    OpenMoveEvalFunction evaluation function.
    This can be used for debugging your code
...
if __name__ == "__main__":
    #minimaxTest(yourAgent=CustomPlayer, minimax_fn=minimax)
    #alpha_pruning_test_eq_to_minimax(yourAgent=CustomPlayer, minimax_fn=alphabeta)
